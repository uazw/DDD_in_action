...
##lambda
in package alert.alertwithlambda i will show you how to use 
lambda instead of decorator to acheve different kinds of alert type.

##decorator
in package alert.alertwithdecorator i use decorator to achieve different kinds of alert type.
